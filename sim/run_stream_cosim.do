# ===========================================================================
# run_stream_cosim.do  --  one-command AXI4-Stream wrapper co-simulation
#
#   Regenerates the Python golden end-to-end vectors, compiles the full core
#   plus the AXI4-Stream wrapper + TB, streams every window through the DUT
#   (with random valid gaps and result back-pressure), and reports PASS/FAIL
...
echo "=== \[4/4\] Running AXI4-Stream co-simulation ==="
vsim -quiet -t 1ps work.tb_stream_cosim +CASES=$NUM_CASES +VECDIR=$VECDIR
run -all
