...
if {[catch {exec python3 scripts/gen_sel_table.py --identity} result]} {
...
if {[catch {exec python python_ref/generate_vectors.py --narrow-core --identity-sel --count $NUM_CASES --seed 31 --out-dir $VECDIR} result]} {
