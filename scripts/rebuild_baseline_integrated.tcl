# Baseline integrated rebuild — full hdc_core_top + runtime mask (Twist-1 silicon seeds).
#
# Requires: HDC_VIVADO_ROOT=/path/to/FInal_HDC (set by run_baseline_integrated_bitstream.sh)
...
source [file join $repo scripts prep_baseline_integrated_project.tcl]
...
close_project
puts "SUCCESS: baseline synthesis/impl/export complete with 0 critical warnings"
puts "XSA: $xsa_file"
